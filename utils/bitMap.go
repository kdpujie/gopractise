...
func (this *BitMap) set(bitIndex uint64) {
	...
	fmt.Printf("\t addr=%p,cap=%d,len=%d \n", this, cap(*this), len(*this))
...
func (this *BitMap) expandTo(wordIndex int) {
	...
	if len(*this) < wordsRequired {
		fmt.Printf("addr=%p,cap=%d,len=%d,wordsRequired=%d \n", this, cap(*this), len(*this), wordsRequired)
